...
# -*- coding: utf-8 -*-
"""
Created on Thu May  2 21:55:05 2019

@author: brgupta
"""

# kernel PCA is a kernelized version of PCA where we map the data using a 
# high dimentional using a kernel trick and then from there we extract some principle component.
# It is manages to deal with non-linear problem.
...
k_pca = KernelPCA(n_components= 2, kernel='rbf')   #Gaussian RBF kernel
X_train = k_pca.fit_transform(X_train)
X_test = k_pca.transform(X_test)
#explained_variance = k_pca.explained_variance_ratio_
